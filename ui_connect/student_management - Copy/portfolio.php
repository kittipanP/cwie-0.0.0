...
$query_Recordset1_stu = sprintf("SELECT student_info.s_id, title.title_name, student_info.s_fname, student_info.s_lname, student_status.status_desc, major_info.major_name, degree_info.degree_name, university_info.uni_name, collage_info.collage_name, student_contact_details.email_adress, student_contact_details.contact_no
			...
			INNER JOIN title ON title.title_id = student_info.title_title_id
			INNER JOIN student_status ON student_status.status_id = student_info.status_id
			LEFT JOIN student_contact_details ON student_contact_details.contact_id = student_contact_details.s_id
			LEFT JOIN education_info ON student_info.s_id = education_info.s_id
			LEFT JOIN major_info ON major_info.major_id = education_info.major_id
			LEFT JOIN degree_info ON degree_info.degree_id = education_info.degree_id
			LEFT JOIN university_info ON university_info.uni_id = education_info.uni_id
  ...
  <div class="w3-row-padding">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          ...
          <div class="w3-display-bottomleft w3-container w3-text-black">
            <h2><?php echo htmlentities($row_Recordset1_stu['s_fname'], ENT_COMPAT, 'utf-8');
					  echo "&nbsp;&nbsp;";
					  echo htmlentities($row_Recordset1_stu['s_lname'], ENT_COMPAT, 'utf-8');  ?></h2>
          </div>
        </div>
        <div class="w3-container">
          <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i>
		  <?php echo $row_studentSet['degree_name']; 
		  		echo " OF ";
				echo htmlentities($row_Recordset1_stu['major_name'], ENT_COMPAT, 'utf-8');?></p>
          <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i>
		  	<?php echo htmlentities($row_Recordset1_stu['uni_name'], ENT_COMPAT, 'utf-8'); ?></p>
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>
          	<?php echo htmlentities($row_Recordset1_stu['email_adress'], ENT_COMPAT, 'utf-8'); ?></p>
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>
          	<?php echo htmlentities($row_Recordset1_stu['contact_no'], ENT_COMPAT, 'utf-8'); ?></p>
          <hr>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card-2 w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Education bg</h2>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>AAAAAAAAAAAAA</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Jan 2015 - <span class="w3-tag w3-teal w3-round">aaaaaaaaaa</span></h6>
          <div align="center">
      ...
      <div class="w3-container w3-card-2 w3-white">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-certificate fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Resume/Transcript/VDO</h2>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>111111111</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>222222222222</h6>
          <p>1111111111111222222222222222222222</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>3333333333</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>44444444444</h6>
          <p>3333333333333333333444444444444444</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>66666666666</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2010 - 2013</h6>
          <p>66666666666666666666666</p><br>
        </div>
      </div>
