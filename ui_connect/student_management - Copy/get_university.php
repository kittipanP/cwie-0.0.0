...
?>  
    ...
    <option value=""><i class="fa fa-thumbs-up w3-margin-right"></i>Can Not Select University</option>
    ...
    <?php
    } while ($row_universitySet = mysql_fetch_assoc($universitySet));
      $rows = mysql_num_rows($universitySet);
      if($rows > 0) {
          mysql_data_seek($universitySet, 0);
          $row_universitySet = mysql_fetch_assoc($universitySet);
      }
    ?><?php }else{ ?>
