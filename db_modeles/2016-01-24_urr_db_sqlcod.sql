...
-- -----------------------------------------------------
-- Table `urr_dbiv`.`institute_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `urr_dbiv`.`institute_info` (
...
CREATE TABLE IF NOT EXISTS `urr_dbiv`.`student_info` (
  ...
  `status_id` INT NULL,
  `ref_id` INT NULL,
  `university_info_uni_id` INT NULL,
  `institute_info_institute_id` INT NULL,
  `student_national_id_national_id` INT NULL,
  ...
  INDEX `fk_student_info_university_info1_idx` (`university_info_uni_id` ASC),
  INDEX `fk_student_info_institute_info1_idx` (`institute_info_institute_id` ASC),
  INDEX `fk_student_info_student_national_id1_idx` (`student_national_id_national_id` ASC),
  ...
  CONSTRAINT `fkstu_ref_id`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fkstu_student_info_university_info1`
    FOREIGN KEY (`university_info_uni_id`)
    REFERENCES `urr_dbiv`.`university_info` (`uni_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fkstu_student_info_institute_info1`
    FOREIGN KEY (`institute_info_institute_id`)
    REFERENCES `urr_dbiv`.`institute_info` (`institute_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fkstu_student_info_student_national_id1`
    FOREIGN KEY (`student_national_id_national_id`)
    REFERENCES `urr_dbiv`.`student_national_id` (`national_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fkstu_student_info_title1`
...
CREATE TABLE IF NOT EXISTS `urr_dbiv`.`student_emergency_contact` (
  ...
  `student_contact_details_contact_id` INT NULL,
  PRIMARY KEY (`emc_id`),
  INDEX `fk_student_emergency_contact_student_contact_details1_idx` (`student_contact_details_contact_id` ASC),
  CONSTRAINT `fk_student_emergency_contact_student_contact_details1`
    FOREIGN KEY (`student_contact_details_contact_id`)
...
CREATE TABLE IF NOT EXISTS `urr_dbiv`.`student_address` (
  ...
  INDEX `s_id_idx` (`s_id` ASC),
  INDEX `country_id_idx` (`country_id` ASC),
  CONSTRAINT `fksadd_id`
    FOREIGN KEY (`s_id`)
    REFERENCES `urr_dbiv`.`student_info` (`s_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fksadd_country_id`
    FOREIGN KEY (`country_id`)
    REFERENCES `urr_dbiv`.`country_list` (`country_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE);
...
CREATE TABLE IF NOT EXISTS `urr_dbiv`.`trainee_visa` (
  ...
  CONSTRAINT `fktvis_trainee_id`
    FOREIGN KEY (`trainee_id`)
    REFERENCES `urr_dbiv`.`trainee_info` (`trainee_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fktvisa_img_id`
    FOREIGN KEY (`img_id`)
...
CREATE TABLE IF NOT EXISTS `urr_dbiv`.`supervisor_contact` (
  ...
  INDEX `dep_id_idx` (`dep_id` ASC),
  INDEX `bldg_id_idx` (`bldg_id` ASC),
  CONSTRAINT `fkspvcon_spv_id`
    FOREIGN KEY (`spv_id`)
    REFERENCES `urr_dbiv`.`supervisor_info` (`spv_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fkspvcon_dep_id`
    FOREIGN KEY (`dep_id`)
    REFERENCES `urr_dbiv`.`department_info` (`dep_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fkspvcon_bldg_id`
    FOREIGN KEY (`bldg_id`)
    REFERENCES `urr_dbiv`.`building_id` (`bldg_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE);
...
CREATE TABLE IF NOT EXISTS `urr_dbiv`.`interview_info` (
  ...
  CONSTRAINT `fkint_application_id`
...
-- -----------------------------------------------------
-- Table `urr_dbiv`.`degree_info_has_institute_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `urr_dbiv`.`degree_info_has_institute_info` (
  `degree_info_degree_id` INT NOT NULL,
  `institute_info_institute_id` INT NOT NULL,
  PRIMARY KEY (`degree_info_degree_id`, `institute_info_institute_id`),
  INDEX `fk_degree_info_has_institute_info_institute_info1_idx` (`institute_info_institute_id` ASC),
  INDEX `fk_degree_info_has_institute_info_degree_info1_idx` (`degree_info_degree_id` ASC),
  CONSTRAINT `fk_degree_info_has_institute_info_degree_info1`
    FOREIGN KEY (`degree_info_degree_id`)
    REFERENCES `urr_dbiv`.`degree_info` (`degree_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_degree_info_has_institute_info_institute_info1`
    FOREIGN KEY (`institute_info_institute_id`)
    REFERENCES `urr_dbiv`.`institute_info` (`institute_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `urr_dbiv`.`degree_info_has_university_info` (
  `degree_info_degree_id` INT NOT NULL,
  `university_info_uni_id` INT NOT NULL,
  PRIMARY KEY (`degree_info_degree_id`, `university_info_uni_id`),
  INDEX `fk_degree_info_has_university_info_university_info1_idx` (`university_info_uni_id` ASC),
  INDEX `fk_degree_info_has_university_info_degree_info1_idx` (`degree_info_degree_id` ASC),
...
CREATE TABLE IF NOT EXISTS `urr_dbiv`.`major_info_has_university_info` (
  `major_info_major_id` INT NOT NULL,
  `university_info_uni_id` INT NOT NULL,
  PRIMARY KEY (`major_info_major_id`, `university_info_uni_id`),
  INDEX `fk_major_info_has_university_info_university_info1_idx` (`university_info_uni_id` ASC),
  INDEX `fk_major_info_has_university_info_major_info1_idx` (`major_info_major_id` ASC),
  CONSTRAINT `fk_major_info_has_university_info_major_info1`
    FOREIGN KEY (`major_info_major_id`)
...
-- -----------------------------------------------------
-- Table `urr_dbiv`.`institute_info_has_major_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `urr_dbiv`.`institute_info_has_major_info` (
  `institute_info_institute_id` INT NOT NULL,
  `major_info_major_id` INT NOT NULL,
  INDEX `fk_institute_info_has_major_info_major_info1_idx` (`major_info_major_id` ASC),
  INDEX `fk_institute_info_has_major_info_institute_info1_idx` (`institute_info_institute_id` ASC),
  PRIMARY KEY (`institute_info_institute_id`, `major_info_major_id`),
  CONSTRAINT `fk_institute_info_has_major_info_institute_info1`
    FOREIGN KEY (`institute_info_institute_id`)
    REFERENCES `urr_dbiv`.`institute_info` (`institute_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_institute_info_has_major_info_major_info1`
    FOREIGN KEY (`major_info_major_id`)
    REFERENCES `urr_dbiv`.`major_info` (`major_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
