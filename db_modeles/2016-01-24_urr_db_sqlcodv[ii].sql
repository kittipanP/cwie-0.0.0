...
CREATE TABLE IF NOT EXISTS `urr_dbv`.`university_info` (
  ...
  CONSTRAINT `fkuni_country_id`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_uniintitute_type`
...
CREATE TABLE IF NOT EXISTS `urr_dbv`.`collage_info` (
  ...
  CONSTRAINT `fkcol_country_id`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fkcoll_intitute_type`
...
CREATE TABLE IF NOT EXISTS `urr_dbv`.`trainee_visa` (
  ...
  CONSTRAINT `fktrn_trainee_id`
    FOREIGN KEY (`trainee_id`)
    REFERENCES `urr_dbv`.`trainee_info` (`trainee_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fktrn_img_id`
    FOREIGN KEY (`img_id`)
...
CREATE TABLE IF NOT EXISTS `urr_dbv`.`sent_email` (
  ...
  CONSTRAINT `fksenm_s_id`
    FOREIGN KEY (`s_id`)
    REFERENCES `urr_dbv`.`student_info` (`s_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fksenm_email_id`
