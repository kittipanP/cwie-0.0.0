...
CREATE TABLE IF NOT EXISTS `urr_dbv`.`university_info` (
  ...
  CONSTRAINT `fk_university_info_intitute_type1`
    ...
    REFERENCES `urr_dbv`.`intitute_type` (`intitute_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `urr_dbv`.`supervisor_contact` (
  ...
  INDEX `dep_id_idx` (`dep_id` ASC),
  INDEX `bldg_id_idx` (`bldg_id` ASC),
  CONSTRAINT `fksvc_spv_id`
    FOREIGN KEY (`spv_id`)
    REFERENCES `urr_dbv`.`supervisor_info` (`spv_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fksvc_dep_id`
    FOREIGN KEY (`dep_id`)
    REFERENCES `urr_dbv`.`department_info` (`dep_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fksvc_bldg_id`
    FOREIGN KEY (`bldg_id`)
    REFERENCES `urr_dbv`.`building_id` (`bldg_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE);
...
CREATE TABLE IF NOT EXISTS `urr_dbv`.`sent_email` (
  ...
  CONSTRAINT `fksem_s_id`
    FOREIGN KEY (`s_id`)
    REFERENCES `urr_dbv`.`student_info` (`s_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fksem_email_id`
...
CREATE TABLE IF NOT EXISTS `urr_dbv`.`interview_info` (
  ...
  CONSTRAINT `fkinv_application_id`
...
-- -----------------------------------------------------
-- Table `urr_dbv`.`education_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `urr_dbv`.`education_info` (
...
-- -----------------------------------------------------
-- Table `urr_dbv`.`trainee_info_has_trainee_activity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `urr_dbv`.`trainee_info_has_trainee_activity` (
  `trainee_info_trainee_id` VARCHAR(15) NOT NULL,
  `trainee_activity_activity_id` INT NOT NULL,
  PRIMARY KEY (`trainee_info_trainee_id`, `trainee_activity_activity_id`),
  INDEX `fk_trainee_info_has_trainee_activity_trainee_activity1_idx` (`trainee_activity_activity_id` ASC),
  INDEX `fk_trainee_info_has_trainee_activity_trainee_info1_idx` (`trainee_info_trainee_id` ASC),
  CONSTRAINT `fk_trainee_info_has_trainee_activity_trainee_info1`
    FOREIGN KEY (`trainee_info_trainee_id`)
    REFERENCES `urr_dbv`.`trainee_info` (`trainee_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_trainee_info_has_trainee_activity_trainee_activity1`
    FOREIGN KEY (`trainee_activity_activity_id`)
...
-- -----------------------------------------------------
-- Table `urr_dbv`.`trainee_info_has_training_course`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `urr_dbv`.`trainee_info_has_training_course` (
  `trainee_info_trainee_id` VARCHAR(15) NOT NULL,
  `training_course_course_id` INT NOT NULL,
  PRIMARY KEY (`trainee_info_trainee_id`, `training_course_course_id`),
  INDEX `fk_trainee_info_has_training_course_training_course1_idx` (`training_course_course_id` ASC),
  INDEX `fk_trainee_info_has_training_course_trainee_info1_idx` (`trainee_info_trainee_id` ASC),
  CONSTRAINT `fk_trainee_info_has_training_course_trainee_info1`
    FOREIGN KEY (`trainee_info_trainee_id`)
    REFERENCES `urr_dbv`.`trainee_info` (`trainee_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_trainee_info_has_training_course_training_course1`
    FOREIGN KEY (`training_course_course_id`)
